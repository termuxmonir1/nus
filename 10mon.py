# Decompile by The MONIR (THE MONIR)
...
######## \033[1;97m##     ## \033[1;92m########
   ...
   ##    \033[1;97m##     ## \033[1;92m##
   ##    \033[1;97m##     ## \033[1;92m########
 \033[1;97m  _______  _____  __   _ _____  ______
...
|__/ |__| |  | |    | | \| |__]     |  |__| |__| |___
 [*]=============================================
    \x1b[0;91m\x1b[1;43m                  MAKING FILE THE MONIR:)                 \x1b[0m
 [*]=============================================
...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/MONIR')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/theMONIR.txt.txt')
...
class sort:
	def __init__(self):
		...
		link = input ("[?] Link 1 : ")
		link1 = input ("[?] Link 2 : ")
		os.system('cat /sdcard/MONIR.txt | grep "'+link+'" > /sdcard/1.txt')
		os.system('cat /sdcard/MONIR.txt | grep "'+link1+'" >> /sdcard/1.txt')
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/Xafthz.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/MONIR.txt.txt')
		os.system('rm -rf /sdcard/MONIRidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("\n[â] Dumping and Sliced successfully ..")
...
class dump_ulti:
	def __init__(self):
		...
		os.system("rm -rf /storage/emulated/0/theMONIR.txt")
		namq = ("theMONIR")
		if namq == "" or namq == " ":
...
class lonte__:
	def __init__(self, ml, token, toket, mamk):
		...
		sys.stdout.write("\r%s[%sTHE MONIR%s] COLLECTED IDZ â¢> %s"%(Q,pilih([U,I,K,M,C]),Q, len(open('/sdcard/'+mamk+'.txt','r').readlines()))
		); sys.stdout.flush()
class menu:
	def __init__(self):
		global ua
